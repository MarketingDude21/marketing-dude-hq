  ...
  public: {
    Tables: {
      ...
      agent_drive_used_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_drive_used_files_agent_id_fkey";
            columns: ["agent_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "agent_drive_used_files_used_in_post_id_fkey";
      ...
      agent_photos: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agent_photos_used_in_post_id_fkey";
            columns: ["used_in_post_id"];
            isOneToOne: false;
            referencedRelation: "generated_posts";
            referencedColumns: ["id"];
      ...
      content_calendar_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_calendar_items_month_id_fkey";
            columns: ["month_id"];
            isOneToOne: false;
            referencedRelation: "content_calendar_months";
            referencedColumns: ["id"];
          },
        ];
      };
      content_calendar_months: {
        Row: {
          archived: boolean;
          created_at: string;
          id: string;
